    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-2xl md:text-4xl font-bold mb-4">Our Medical Team</h1>
          <p className="text-lg md:text-xl">Meet our experienced healthcare professionals</p>
        </div>
      </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-xl md:text-3xl font-bold mb-4">Join Our Team</h2>
          ...
          <a 
            href="/careers" 
            className="inline-block bg-blue-600 text-white md:px-6 md:py-3 px-4 py-2 rounded-md hover:bg-blue-700 transition-colors"
          >
            View Open Positions
          </a>
        </div>
