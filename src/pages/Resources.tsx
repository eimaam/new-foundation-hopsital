    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl">Stay informed with our latest updates and educational materials</p>
        </div>
      </div>
        ...
        <section id="events">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="border-l-4 border-blue-600 pl-4 mb-6">
              <h3 className="text-xl font-semibold mb-2">Community Health Awareness Day</h3>
            ...
            <div className="border-l-4 border-blue-600 pl-4">
              <h3 className="text-xl font-semibold mb-2">Maternal Health Workshop</h3>
